...
If (ii), the table can -with Stata 15.1 or later- be saved into a .docx file 
using the command {help table1_mc_dta2docx:table1_mc_dta2docx}.{p_end}
...
{sf:. cd "H:\"   (or whichever directory you want to save to)} {break}
{sf:. }{stata `"table1_mc_dta2docx using "example Table 1.docx", replace landscape"'} {break}
